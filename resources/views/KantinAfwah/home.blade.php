...
<body>
                    ...
                    <div class="col-xl-6">
                        <div class="d-flex align-items-center">
                            <div class="content-header me-5">
                                ...
                                <h4>Phone:<a href="callto:+1(850)344066">+62 813-7166-3181</a></h4>
                            </div>
    ...
    <section class="gap">
        <div class="container">
            ...
            <div class="hamburger-icon">
                <a href="{{ route('KantinAfwah.halamanpromo') }}" class="button">Promo Menarik Lainnya</a>
            </div>
        </div>
    </section>
    ...
    <section class="gap our-blog" style="background-color: #f5f8fd;">
        <div class="container">
                ...
                @foreach ($menu as $item) <!-- Looping data menu -->
                    <div class="item col-xl-12">
                        <div class="featured-dishes">
                            ...
                            <div class="featured-dishes-img">
                                <img alt="featured-dishes" src="{{ Storage::url($item->gambar) }}" style="display: flex; justify-content: center; align-items: center; width: 250px; height: 250px; overflow: hidden; margin: 0 auto;">
                            </div>
            ...
            <!-- Tombol menuju halaman lebih lanjut -->
            <div class="hamburger-icon">
                <a href="{{ route('KantinAfwah.daftarmenu') }}" class="button">Lihat Semua Menu</a>
            </div>
        </div>
    </section>
