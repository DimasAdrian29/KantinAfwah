...
<body>
    ...
    <section id="about" class="container mt-5 about-section">
        <div class="row text-center">
            <div class="col-lg-6">
                <h2>About Us</h2>
                <p class="lead">Kantin Afwah adalah tempat makan yang didirikan dengan tujuan untuk menyediakan hidangan lezat, bergizi, dan terjangkau untuk semua kalangan. Kami percaya bahwa makanan adalah salah satu elemen penting dalam menjalani kehidupan yang sehat dan bahagia. Oleh karena itu, setiap hidangan yang kami sajikan dipersiapkan dengan bahan-bahan berkualitas tinggi dan disajikan dengan cita rasa yang khas.</p>
