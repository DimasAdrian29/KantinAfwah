            ...
            <div class="mb-4">
                ...
                <div class="mt-1">
                    <label class="inline-flex items-center">
                        <input type="radio" name="jenis_menu" value="makanan"
                               class="border-gray-300 rounded-md"
                               {{ $menu->jenis_menu === 'makanan' ? 'checked' : '' }} required />
                        <span class="ml-2">Makanan</span>
                    </label>
                    <label class="inline-flex items-center ml-4">
                        <input type="radio" name="jenis_menu" value="minuman"
                               class="border-gray-300 rounded-md"
                               {{ $menu->jenis_menu === 'minuman' ? 'checked' : '' }} required />
