   ...
   <section class="py-20 relative overflow-x-hidden bg-gradient-to-b from-red-500/5 to-amber-500/5" data-aos="fade-up" data-aos-duration="600">
    <div class="absolute top-0 inset-x-0 hidden sm:block">
        <img src="dist/assets/images/shapes/white-wave.svg" alt="svg" class="w-full -scale-x-100">
    </div>
    <div class="container relative">
        <div class="relative z-20">
            <div class="flex items-center justify-between pb-14">
                <div>
                    <h2 class="md:text-3xl text-xl font-semibold my-5">Kind words from excellent clients</h2>
                </div>
                ...
                <div id="swiper_two" class="swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="p-12 bg-white border">
                                ...
                                <div class="flex items-center justify-between mt-5">
                                    <div class="flex items-center gap-3">
                                        <div>
                                            <img src="dist/assets/images/avatars/img-1.jpg" class="w-10 rounded-full">
                                        </div>
                                        <div>
                                            <h6>John Stark</h6>
                                    ...
                                    <div>
                                        <img src="dist/assets/images/brands/amazon.svg" class="w-24">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="p-12 bg-white border">
                                ...
                                <div class="flex items-center justify-between mt-5">
                                    <div class="flex items-center gap-3">
                                        <div>
                                            <img src="dist/assets/images/avatars/img-2.jpg" class="w-10 rounded-full">
                                        </div>
                                        <div>
                                    ...
                                    <div>
                                        <img src="dist/assets/images/brands/google.svg" class="w-24">
                                    </div>
                                </div>
                            </div>
                        </div>
